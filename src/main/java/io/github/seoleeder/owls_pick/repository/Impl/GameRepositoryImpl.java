...
public class GameRepositoryImpl implements GameRepositoryCustom {
     ...
     */
    @Override
    public Page<ExploreGameResult> findGamesByGenre(GenreType genre, GameSortType sort, Pageable pageable) {
        // 데이터를 가져오는 Main Query
        List<ExploreGameResult> content = queryFactory
                .select(Projections.constructor(
                        ExploreGameResult.class,
                        game,
                        reviewStat
                ))
                .from(game)
     ...
     */
    @Override
    public Page<ExploreGameResult> findGamesByTheme(ThemeType theme, GameSortType sort, Pageable pageable) {
        List<ExploreGameResult> content = queryFactory
                .select(Projections.constructor(
                        ExploreGameResult.class,
                        game,
